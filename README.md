...
목표 금액을 못 모아도 공원에 갈 수 있습니다. 완주 때 15,000원을 모으면 간판과 설비 자리가 생깁니다. 넓은 보관은 최대 8잔·하루 1,000원, 새 메뉴는 재료비가 200원 더 드는 따뜻한 레몬티입니다. 공원 둘째·넷째 날에는 다음 날 단체 주문을 선택할 수 있습니다.

날씨와 손님, 재료비는 날마다 달라집니다. 기본 설비는 셋째·넷째 날 하루 600원에 최대 4잔을 다음 영업까지 보관할 수 있습니다. 보관함을 쓰지 않거나 판매 기한이 지난 음료는 정리합니다. 내일의 재료값과 손님 단서를 보고 보관을 결정합니다. 현금과 이익은 구분해 보여주며, 설명은 영업 뒤 선택해서 열어볼 수 있습니다.
...
검증에는 다섯 번의 영업, 수익 계산, 같은 날 재시도, 새로고침 복구, 보관·기한·대여 유불리, 감사 스크롤의 중지·동작 감소·기록 보존·재시작, 공원 두 주간·설비·선불 주문·납품·최고 기록 보존, 기존 v1/v2 저장의 이어하기, 손상된 저장값, 저장 불가 환경, PC와 모바일 390×844 화면이 포함됩니다. 자동 검증은 실제 사용자의 재미나 경제 이해를 입증하지 않습니다.
