  ...
  return `<dialog class="credits-dialog" aria-labelledby="credits-title" aria-describedby="credits-summary">
    ...
    <div class="credits-scroll" id="credits-scroll" tabindex="0" role="region" aria-label="플레이 감사 인사와 개발 중 안내">
      <div class="credits-roll">
        <section class="credits-opening"><div class="credits-sun" aria-hidden="true">☀</div><p class="credits-eyebrow">작은 가게의 첫 번째 이야기</p><h2 id="credits-title" tabindex="-1">플레이해 주셔서<br> 고맙습니다.</h2><p>당신의 선택으로<br> 작은 가게의 다섯 오후가 채워졌어요.</p><span class="credits-memory">다섯 번의 오후 · ${sold}잔의 레모네이드</span></section>
        <section class="credits-chapter"><span class="credits-chapter-mark" aria-hidden="true">✧</span><p class="credits-eyebrow">이번 장터는 여기까지</p><h3>아직 만들어가는<br> 오후입니다.</h3><p>지금은 다섯 번의 영업을 담은<br> 개발 중인 버전이에요.</p><p>더 오래 궁금하고,<br> 다시 해도 새로운 장터를 준비하고 있어요.</p></section>
        <section class="credits-chapter credits-future"><p class="credits-eyebrow">앞으로 만들어갈 이야기</p><h3>다음 오후에는</h3><div><h4>오늘과 다른 손님</h4><p>장터가 바뀌면<br> 어제의 좋은 선택도 다시 생각하게 돼요.</p></div><div><h4>내 선택이 남는 가게</h4><p>모은 돈과 고민한 선택이<br> 가게의 모습과 할 수 있는 일을 바꿔요.</p></div><div><h4>조금 더 멀리 보는 장사</h4><p>오늘 남기는 돈과<br> 내일을 위해 남겨두는 가능성 사이에서.</p></div><small>아직 플레이할 수 없는 후속 개발 방향이에요.</small></section>
