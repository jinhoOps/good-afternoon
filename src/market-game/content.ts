...
export const DAYS: MarketDay[] = [
  {
    ...
    news: '“삼천 원이면 산책하면서 한 잔 마시기 좋겠네.”',
    hint: '오늘은 한 잔에 3,000원. 먼저 얼마나 준비할지 골라보세요.', cost: 1500,
    visitors: visitors([3300, 3600, 3000, 3900, 3000, 3600], '산책하다가 들렀어요.'),
  ...
  },
  {
    ...
    hint: '오늘부터 가격도 정해요. 비싸게 팔면 한 잔에 더 남지만, 돌아서는 손님도 있어요.', cost: 1500,
    visitors: visitors([4500, 4200, 3300, 3000, 4800, 3600, 2700, 4500, 3900, 3300, 4200, 3000], '운동하고 나니 목말라요.'),
  ...
  },
  {
    ...
    hint: '어제 잘 팔렸어도 오늘은 달라요. 오늘 팔 물량과 내일 가져갈 음료를 함께 생각해보세요.', cost: 1500,
    visitors: visitors([2400, 2700, 3600, 3000, 2700], '잠깐 비를 피하고 있어요.'),
  ...
  },
  {
    ...
    news: '재료상 소식 · 오늘부터 한 잔 재료비가 1,500원 → 2,100원이에요.',
    hint: '판매가가 같아도 재료비가 오르면 남는 돈이 줄어요. 오늘의 가격표를 다시 봐주세요.', cost: 2100,
    visitors: visitors([3000, 3600, 3900, 4200, 4500, 3600, 4800, 3000, 3900], '레몬 향이 좋네요.'),
  ...
  },
  {
    ...
    hint: '마지막 영업이에요. 손님 수, 한 잔의 이익, 준비할 물량을 함께 골라보세요.', cost: 2100,
    visitors: visitors([2700, 3000, 3300, 3600, 3900, 4800, 4500, 5400, 3600, 4200, 4500, 3300, 4200, 3000, 5100, 3600], '저기서 곧 공연한대요!'),
    concept: { title: '현금의 흐름', description: '오늘 재료에 쓴 돈, 판매로 들어온 돈, 마지막에 남은 돈을 이어보면 내 장사가 어떻게 달라졌는지 알 수 있어요.' }
  }
];

export const PRICES = [2400, 3000, 3600, 4500] as const;
export const INITIAL_CASH = 18000;
export const DREAM_CASH = 45000;
export const MAX_STOCK = 18;
export const COOLER_FEE = 1800;
