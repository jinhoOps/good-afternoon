...
> 2026-09-09 상태: 과거의 조작 중심 설계 자료입니다. 사용자 요청으로 기존 구현 전체를 재검토하며, 현재 제안은 [첫 오후 재설계 검토안](2026-09-09-pre-cyan-game-rebuild-design.md)에 있습니다. 이 문서를 새 구현의 승인된 전체 명세로 취급하지 않습니다.
