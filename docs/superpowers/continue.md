...
규칙 테스트와 PC·모바일 브라우저 검증을 수행했습니다. 보관 대여와 다음 영업으로 이어지는 재고, 현금과 이익의 구분을 후속 구현했습니다. 기존 v1 저장을 이어 읽습니다. 실제 사용자의 재미와 경제 이해, 장기 숙련은 아직 관찰하지 않았습니다. 감사·개발 중 스크롤은 완주 후 반복 진입에 연결했습니다. 후속 장터·가게 성장·장기 판단의 순서는 [첫 장터 이후의 설계](../design/after-first-market.md)를 확인합니다. 후속 콘텐츠는 설계 단계이며 현재 플레이 가능한 기능으로 보고하지 않습니다.
