...
규칙 테스트와 PC·모바일 브라우저 검증을 수행했습니다. 보관 대여와 다음 영업으로 이어지는 재고, 현금과 이익의 구분을 후속 구현했습니다. 기존 v1 저장을 이어 읽습니다. 실제 사용자의 재미와 경제 이해, 장기 숙련은 아직 관찰하지 않았습니다. 다음 작업은 기능 목록을 늘리기 전에 플레이 중의 판단과 재시도 동기를 확인하는 것입니다.
